    ...
    )
{
    ...
    struct ffss_super_block*    ffss_super_block = NULL;
    ...
    __try
    {
        ...
        VolumeLabelLength = (USHORT) strlen(FFSSLABEL);
        ...
        FsdCharToWchar(Vcb->Vpb->VolumeLabel,FFSSLABEL,VolumeLabelLength);
    ...
    )
{
    ...
    __try
    {
        ...
        Status = FsdIsDeviceSameRomfs(Vcb->TargetDeviceObject,0x1234);
